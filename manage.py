...
app = create_app(os.getenv('JXZYK_CONFIG') or 'default')
...
# admin = Admin(app, name='后台页', template_mode='bootstrap3',index_view=AdminIndexView(name='导航栏',
# template='admin/welcome.html')) #,url='/admin'
...
def make_shell_context():
    return dict(db=db, User=User, Jxsource=Jxsource, Zytype=Zytype)
